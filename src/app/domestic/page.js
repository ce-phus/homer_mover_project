...
import { hero1, hero8 } from '@/assets'
  ...
  return (
    ...
    <div className='flex flex-row lg:flex-col sm:flex-co'>
        ...
        <div className='w-full text-center flex flex-col items-center justify-center bg-grade space-y-5'>
            <h1 className='mt-5 text-4xl font-medium tracking-wide text-primary'>Domestic Relocation Services</h1>

            <h1 className='text-2xl text-dark tracking-wide font-medium'>Making Local Moves Effortless</h1>

            <ul className='space-y-2 mb-20'>
                <li className='space-x-2 flex'>
                    <TiTick className='text-xl text-primary mt-1'/>
                    <p className='text-xl font-medium'>Home Search Assistance: <span className='text-lg font-normal'>Helping you find the perfect home in Surrey or elsewhere in the UK.</span></p>
                </li>

                <li className='space-x-2 flex'>
                    <TiTick className='text-xl text-primary mt-1'/>
                    <p className='text-xl font-medium'>Moving Logistics:  <span className='text-lg font-normal'>Coordinating with trusted moving companies to handle your belongings with care.</span></p>
                </li>

                <li className='space-x-2 flex'>
                    <TiTick className='text-xl text-primary mt-1'/>
                    <p className='text-xl font-medium'>Neighborhood Orientation: <span className='text-lg font-normal'>Providing insights into schools, amenities, and local communities.</span></p>
                </li>

                <li className='space-x-2 flex mb-20'>
                    <TiTick className='text-xl text-primary mt-1'/>
                    <p className='text-xl font-medium'>Custom Support: <span className='text-lg font-normal'>Services designed to meet your unique needs, from downsizing to relocating for a new job.</span></p>
                </li>
            </ul>
        </div>
    </div>
