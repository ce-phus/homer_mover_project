...
const Services = () => {
  return (
    <>
        ...
        <div className='pt-10 pb-20 grid grid-cols-3 lg:grid-cols-2 sm:grid-cols-1 gap-3 lg:gap-5 mx-4'>
        <div className='space-y-3 text-center'>
            <Link href={'/domestic'} className='space-y-5 flex flex-col justify-center items-center'>
                <Image 
                src={hero16}
                className='w-[500px] lg:h-[400px] xl:w-[400px] xl:h-[400px] lg:w-[400px] h-[500px]'
                alt='service3'/>
        ...
        <div className='text-center'>
            <Link href={'/international'} className='space-y-5 flex flex-col justify-center items-center'>
                <Image 
                src={hero3}
                className='w-[500px] xl:w-[400px] xl:h-[400px] lg:h-[400px] lg:w-[400px] h-[500px]'
                alt='service1'/>
