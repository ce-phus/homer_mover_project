...
const Navbar = () => {
    ...
    return (
        <>
            <nav
                className={`w-full bg-[#301934] border border-transparent p-2 text-white transition-all duration-300 ${
            ...
            <nav className={`w-full text-white fixed z-20 ${scrolled ? "bg-primary absolute top-20" : "bg-[#353935] "}`}>
