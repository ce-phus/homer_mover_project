...
import { guildford, woking, cobham, esher, reigate, download, reigate1, dorking, countryside1, surreypic } from '@/assets'
        ...
        <div className='grid grid-cols-3 lg:grid-cols-2 md:grid-cols-1 gap-20 xl:gap-[60px] mx-4 pt-10'>
            {surrey.map((post)=> (
                <div key={post.id} className='flex flex-col items-center space-y-3 duration-300 ease-in-out hover:scale-105'>
                    ...
                    src={post.img}
                    alt={post.title1}
                    className='w-[600px] lg:h-[400px] xl:w-[500px] xl:h-[350px] lg:w-[400px] h-[400px] mb-5'/>
