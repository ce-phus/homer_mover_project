    ...
    <div className='max-w-7xl mx-auto pt-20 lg:pt-10'>
        ...
        <div className='flex flex-col justify-center mt-10 xl:mt-8 lg:mt-5'>
            ...
            <ul className='list-disc list-inside ml-3'>
                <li className='font-medium text-md'>Personal information: <span className='font-normal text-mg'>Name, email address, phone number, mailing address, and any other information you provide when filling out forms or contacting us.</span></li>
            
                <li className='font-medium text-md'>Non-Personal Information: <span className='font-normal text-mg'>Data automatically collected through cookies, log files, and similar technologies, such as your IP address, browser type, operating system, and browsing behaviour on our Site.</span></li>
            </ul>
        </div>
        ...
        <div className='flex flex-col justify-center mt-10 xl:mt-8 lg:mt-5'>
            ...
            <ul className='list-disc list-inside ml-3'>
                <li className='font-normal text-md'>Provide, operate, and maintain our Site and services.</li>
            
                <li className='font-normal text-md'>Improve, personalize, and expand our Site and services.</li>
            
                <li className='font-normal text-md'>Respond to your comments, questions, and requests, and provide customer support.</li>

                <li className='font-normal text-md'>Process transactions and send you related information, including confirmations and invoices.</li>

                <li className='font-normal text-md'>Send you marketing communications, updates, and other information that may be of interest to you.</li>

                <li className='font-normal text-md'>Monitor and analyse usage and trends to improve your experience on our Sit</li>
            </ul>
        </div>
        ...
        <div className='flex flex-col justify-center mt-10 xl:mt-8 lg:mt-5'>
            ...
            <ul className='list-disc list-inside ml-3'>
                <li className='font-medium text-md'>Service Providers: <span className='font-normal text-mg'>We may share your information with third-party vendors and service providers who perform services on our behalf (e.g., payment processing, data analytics, hosting).</span></li>
            
                <li className='font-medium text-md'>Legal Requirements: <span className='font-normal text-mg'>We may disclose your information if required to do so by law or in response to valid requests by public authorities (e.g., a court or government agency).</span></li>

                <li className='font-medium text-md'>Business Transfers: <span className='font-normal text-mg'>If we are involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction.</span></li>
            </ul>
        </div>
        ...
        <div className='flex flex-col justify-center mt-10 xl:mt-8 lg:mt-5'>
            ...
            <ul className='list-disc list-inside ml-3'>
                <li className='font-normal text-md'>The right to access, update, or delete the information we hold about you.</li>
            
                <li className='font-normal text-md'>The right to object to or restrict certain types of processing of your personal information.</li>
            
                <li className='font-normal text-md'>The right to data portability.
